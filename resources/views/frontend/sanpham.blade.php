...
<div class="container py-5">
    <div class="row mb-5">
        <div class="col-12 text-center animate__animated animate__fadeInDown">
            <h2 class="display-5 playfair text-gold">{{ $tenLoai }}</h2>
        ...
        <div class="col-lg-3 animate__animated animate__fadeInLeft">
            <div class="bg-dark p-4 border border-secondary border-opacity-25 rounded-0 sticky-top" style="top: 100px;">
                ...
                <ul class="list-unstyled mb-5">
                    <li class="mb-2">
                        <a href="{{ route('frontend.sanpham') }}" class="text-decoration-none transition-all {{ request()->routeIs('frontend.sanpham') && empty(request()->route('tenloai_slug')) ? 'text-white fw-bold' : 'text-secondary hover-white' }}">
                            <i class="fa-solid fa-angle-right me-2 text-gold" style="font-size: 0.7em;"></i> Tất cả sản phẩm
                        </a>
                    </li>
                    @foreach($loaisanpham as $loai)
                    <li class="mb-2">
                        <a href="{{ route('frontend.sanpham.theoloai', ['tenloai_slug' => $loai->tenloai_slug]) }}" class="text-decoration-none transition-all {{ request()->route('tenloai_slug') == $loai->tenloai_slug ? 'text-white fw-bold' : 'text-secondary hover-white' }}">
                            <i class="fa-solid fa-angle-right me-2 text-gold" style="font-size: 0.7em;"></i> {{ $loai->tenloai }}
                        </a>
                    </li>
                    @endforeach
                </ul>
        ...
        <div class="col-lg-9 animate__animated animate__fadeInRight">
            <div class="row g-4">
                ...
                <div class="col-12 text-center py-5 border border-secondary border-opacity-25 bg-dark">
                    ...
                    <p class="text-white lead mb-4">Chưa có sản phẩm nào trong danh mục này.</p>
                </div>
                @endforelse
            </div>
